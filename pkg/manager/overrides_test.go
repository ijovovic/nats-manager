	...
	testCases := []struct {
		...
		},
		{
			...
			wantOverrides: map[string]any{
				...
				MetricsResourceRequestsCPUKey: "20m",
				MetricsResourceRequestsMemKey: "64Mi",
				MetricsResourceLimitsCPUKey:   "60m",
				MetricsResourceLimitsMemKey:   "128Mi",
...
func Test_Overrides_Keys(t *testing.T) {
	...
	keysToTest := map[string]any{
		...
		MetricsResourceRequestsCPUKey: "10m",
		MetricsResourceRequestsMemKey: "20Mi",
		MetricsResourceLimitsCPUKey:   "50m",
		MetricsResourceLimitsMemKey:   "32Mi",
